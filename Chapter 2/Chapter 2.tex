...
\begin{document}
	...
	\begin{answered}
		This is identical to the previous proof except that instead of supposing that our entropy-maximising case has outcomes that do not have equal probabilities, we suppose that our pdf has a region of non-zero measure with an average p.d.f not equal to $\frac{1}{b-a}$. The rest of the proof follows in the same way.
	\end{answered}
